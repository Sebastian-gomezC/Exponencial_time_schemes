...
if type_plot == "t-L2":
    ...
    plot = error.plot(x='tiempo',xlim=[0,10],ylim=[1e-5,1],title=f"Error convergence for dt = {dt}",logy=True,grid=True,xlabel='time',ylabel='$L_2$ norm')
    ...
    types=[70,100,115,120,125,126,128,129,130,131]
